const translations = {
  en: {
    ...
    about: {
      heading: 'About Me',
      p1: "I'm Ayub, a frontend developer focused on building modern, responsive and user-friendly websites using React and modern web technologies.",
      p2: 'With a passion for clean code and intuitive design, I bridge the gap between complex backend logic and seamless user experiences. I love turning creative ideas into functional, high-performance web applications.',
      p3: "When I'm not coding, you'll find me exploring new design trends, contributing to open-source projects, or learning about the latest advancements in the web ecosystem.",
  ...
  ar: {
    ...
    about: {
      heading: 'من أنا',
      p1: 'أنا أيوب، مطور واجهة أمامية متخصص في بناء مواقع ويب حديثة وسريعة الاستجابة وسهلة الاستخدام باستخدام React وأحدث تقنيات الويب.',
      p2: 'بشغفي بالكود النظيف والتصميم البديهي، أجسر الفجوة بين منطق الواجهة الخلفية المعقد وتجارب المستخدم السلسة. أحب تحويل الأفكار الإبداعية إلى تطبيقات ويب وظيفية وعالية الأداء.',
      p3: 'عندما لا أكون أكتب الكود، ستجدني أستكشف اتجاهات التصميم الجديدة، أساهم في مشاريع المصدر المفتوح، أو أتعلم أحدث التطورات في منظومة الويب.',
      yearsExp: 'سنوات الخبرة',
      projectsDone: 'مشروع منجز',
      happyClients: 'عميل سعيد',
      skills: 'مهاراتي',
      learningTitle: 'تعلّم مستمر',
      learningDesc:
